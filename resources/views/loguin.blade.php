...
<head>
    ...
    @vite(['resources/css/registrar.css', 'resources/js/script.js', ])
</head>
<body>
                ...
                <form class="form form-register" novalidate>
                    ...
                    <div>
                        <label>
                            ...
                            <input type="text" placeholder="Telefono" name="userTelefono" >
                        </label>
                    </div>
                    <div>
                        <label >
                   ...
                   <div>
                    ...
                    <a href="{{route('home')}}" style="text-decoration: none;">Registrarse</a>
        ...
        <div class="form-information">
            <div class="form-information-childs">
                ...
                <form class="form form-login"novalidate>
                    ...
                    <a href="{{route('home')}}" style="text-decoration: none;">Iniciar Sesion</a>
                    <div class="alerta-error">Todos los campos son obligatorios</div>
                    <div class="alerta-exito">Te registraste correctamente</div>
                </form>
            </div>
